...
echo "Setting up Worker local development environment..."
...
echo "✓ Worker local development environment ready!"
echo ""
echo "To activate the virtual environment, run:"
echo "  source venv/bin/activate"
echo ""
echo "To run the worker locally:"
echo "  celery -A main worker --loglevel=info"
